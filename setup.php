 ...
 * Initial configuration for NXDNReflector Dashboard
 * Copyright (C) 2025  Shane Daley, M0VUB Aka. ShaYmez
 * REMOVE THIS FILE AFTER SETUP IS COMPLETE!
 */

// Default configuration values
if (!defined("NXDNREFLECTORLOGPATH")) define("NXDNREFLECTORLOGPATH", "/var/log/NXDNReflector/");
...
if (!defined("NXDNREFLECTORPATH")) define("NXDNREFLECTORPATH", "/usr/local/bin/");
...
<body class="setup-bg">
    ...
    <?php
        ...
        fwrite($configfile,"/**\n");
        fwrite($configfile," * NXDNReflector-Dashboard2 Configuration\n");
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="NXDNREFLECTORLOGPATH" value="<?php echo constant("NXDNREFLECTORLOGPATH") ?>" 
                                       class="input-glossy w-full" placeholder="/var/log/NXDNReflector/" required>
                            </div>
                            <div>
